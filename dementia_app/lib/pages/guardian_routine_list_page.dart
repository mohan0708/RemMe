...
import 'routine/add_edit_routine_page.dart';
...
class GuardianRoutineListPage extends StatefulWidget {
  ...
  @override
  _GuardianRoutineListPageState createState() => _GuardianRoutineListPageState();
}
...
class _GuardianRoutineListPageState extends State<GuardianRoutineListPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Create the first reminder to help manage daily activities',
                      style: TextStyle(
                        fontSize: 15,
  ...
  void _navigateToAddRoutine() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AddEditRoutinePage(
